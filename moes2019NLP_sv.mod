...
subject to dTLMEvaporatorHPhigh{t in Time}: #the logarithmic mean temperature in the evaporator can be computed using the inlet and outlet temperatures, Note: should be in K
